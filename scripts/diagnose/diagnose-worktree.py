"""Report safe remediation for Git worktree branch conflicts."""
...
def main() -> int:
    ...
    if bare:
        print(
            "warning: this directory is a bare Git repository; run development "
            "commands from a listed worktree."
        )
    ...
    print(
        ...
        f"git worktree remove {owner.path!r} only when it is no longer active."
    )
    return 0
