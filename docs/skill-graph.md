...
select models, or enforce host permissions. The `domain` module owns the graph;
the [architecture record](architecture.md) states that ownership and the
dependency direction it allows.
