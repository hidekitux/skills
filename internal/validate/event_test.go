...
func TestBranchPolicyAcceptsTracksWithClosingKeywordInInlineCode(t *testing.T) {
	body := "## Issue\n\nTracks #35\n\n## Summary\n\nDo not write `Closes #35` here.\n"
	if !matchingIssueLinkStartsBody(body, 35) {
		t.Fatal("expected match")
	}
}
...
func TestBranchPolicyRejectsMixedClosesAndTracks(t *testing.T) {
	for _, body := range []string{
		...
		"## Issue\n\nTracks #35\n\n## Summary\n\nFixes https://github.com/hidekitux/skills/issues/35\n",
	} {
		if matchingIssueLinkStartsBody(body, 35) {
